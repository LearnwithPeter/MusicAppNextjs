...
export default function Whychooseus() {
  const musicSchoolContent = [
    ...
    },
    {
      ...
      description:
        'With our expansive resource library and dynamic course offerings, you all never find yourself without something new to explore. Our platform provides continuous opportunities for growth, ensuring your musical skills are always advancing.',
    },
  ];
  return (
    <div>
